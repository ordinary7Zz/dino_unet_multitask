...
run_experiment "train_multitask_FTCPTC_sampler_segcls_pf02_ns6000" "seg,cls"
run_experiment "train_multitask_FTCPTC_sampler_clsclsseg_pf02_ns6000" "cls,cls,seg"
