...
TRAIN_LABEL_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Classifaction_Data/Malignant_ultrasound_images_cropped/ftcptc_single_train_labels.json"  # 添加分类标签路径
EPOCH=20
LR=1e-4
BATCH_SIZE=12
...
EVAL_INTERVAL=2
DATASET_NAME="train_multitask_${Train_DATASET}_with_single_label"
