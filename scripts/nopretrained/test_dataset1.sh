...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/nopretrained/nopretrained_train_multitask_dataset1/20251226_103141/dino_unet_nopretrained_train_multitask_dataset1_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/nopretrained/test_dataset1"
