...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/Dilation/Dilation_train_multitask_dataset4/20260112_185947/dino_unet_Dilation_train_multitask_dataset4_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/Dilation/test_dataset4"
