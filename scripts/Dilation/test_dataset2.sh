...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/Dilation/Dilation_train_multitask_dataset2/20260114_230229/dino_unet_Dilation_train_multitask_dataset2_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/Dilation/test_dataset2"
