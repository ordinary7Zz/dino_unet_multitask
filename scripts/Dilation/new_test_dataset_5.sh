...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/Dilation/dino_unet_Dilation_train_multitask_${DATASET_NAME}_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/Dilation/new_test_${DATASET_NAME}"
