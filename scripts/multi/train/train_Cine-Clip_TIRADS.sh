...
# 设置训练参数
Train_DATASET="Cine-Clip"
CUDA_VISIBLE_DEVICES="1"
METHOD="dino_unet"
TRAIN_IMAGE_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/${Train_DATASET}/train/images/"
TRAIN_MASK_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/${Train_DATASET}/train/masks/"
TRAIN_LABEL_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/train_val_test/${Train_DATASET}/train/${Train_DATASET}_train_label.json"  # 添加分类标签路径
EPOCH=50
LR=1e-4
BATCH_SIZE=12
CHECKPOINT_DIR="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/TIRADS"
CHECKPOINT_INTERVAL=5
EVAL_INTERVAL=5
DATASET_NAME="train_TIRADS_${Train_DATASET}"
