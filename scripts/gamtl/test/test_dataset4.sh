...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/gamtl/train_multitask_dataset4/20260112_202228/dino_unet_train_multitask_dataset4_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/gamtl/test_dataset4"
