...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/gamtl/gamtl_train_multitask_dataset2/20260114_230222/dino_unet_gamtl_train_multitask_dataset2_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/gamtl/test_dataset2"
