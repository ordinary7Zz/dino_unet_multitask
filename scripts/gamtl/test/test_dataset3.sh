...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/gamtl/gamtl_train_multitask_dataset3/20260114_122920/dino_unet_gamtl_train_multitask_dataset3_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/gamtl/test_dataset3"
