...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/baseline/train_multitask_dataset3/20251218_220310/dino_unet_train_multitask_dataset3_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/baseline/test_dataset3"
