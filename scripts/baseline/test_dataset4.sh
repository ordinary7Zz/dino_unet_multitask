...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/baseline/train_multitask_dataset4/20251211_210937/dino_unet_train_multitask_dataset4_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/baseline/test_dataset4"
