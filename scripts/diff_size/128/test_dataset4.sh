...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/diff_size/128/diff_size_train_multitask_dataset4/20260110_234301/dino_unet_diff_size_train_multitask_dataset4_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/diff_size/$IMG_SIZE/test_dataset4"
