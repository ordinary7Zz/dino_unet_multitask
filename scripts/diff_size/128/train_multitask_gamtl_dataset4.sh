...
BATCH_SIZE=12
IMG_SIZE=128
CHECKPOINT_DIR="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/diff_size/$IMG_SIZE"
CHECKPOINT_INTERVAL=5
EVAL_INTERVAL=5
DATASET_NAME="${IMG_SIZE}size_train_multitask_dataset4"
