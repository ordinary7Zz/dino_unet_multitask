...
METHOD="dino_unet"
TRAIN_IMAGE_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_multitask/dataset_1/images/"
TRAIN_MASK_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_multitask/dataset_1/masks/"
TRAIN_LABEL_PATH="/mnt/wangbd8/workspace/DataSets/ThyroidAgent/Superimposed_multitask/dataset_1/dataset1_label.json"  # 添加分类标签路径
EPOCH=50
LR=1e-4
BATCH_SIZE=12
IMG_SIZE=448
...
EVAL_INTERVAL=5
DATASET_NAME="${IMG_SIZE}size_train_multitask_dataset1"
