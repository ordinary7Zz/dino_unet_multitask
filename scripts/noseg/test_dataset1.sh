...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/noseg/noseg_train_multitask_dataset1/20251227_104945/dino_unet_noseg_train_multitask_dataset1_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/noseg/test_dataset1"
