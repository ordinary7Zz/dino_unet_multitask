...
CHECKPOINT_PATH="/mnt/wangbd8/workspace/ThyroidAgent/dino_unet_multitask/checkpoints/noseg/noseg_train_multitask_dataset4/20251227_114901/dino_unet_noseg_train_multitask_dataset4_epoch_50.pth"
...
# Log directory
LOG_DIR="./logs/test_logs/noseg/test_dataset4"
